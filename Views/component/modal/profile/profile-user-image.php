...
<img id="preview-profile-image" src="<?= htmlspecialchars(is_null($profile->getUploadFullPathOfProfileImage()) ? '/images/default-icon.svg' : $profile->getUploadFullPathOfProfileImage()) ?>" alt="プロフィール画像" class="size-40 absolute -bottom-20 left-5 border-8 border-white rounded-full bg-white">
